...
with open(r"Output\counter.txt", 'r') as f_cin:
...
with open(r'Output\2304_chatgpteval_raw_predictions.pkl', 'wb') as handle:
...
data.to_csv(
    r"Output\2304_chatgpteval_1k_sample_with_predictions.csv",
    encoding='UTF-8',
    sep=';'
)
